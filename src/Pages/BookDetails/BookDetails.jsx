...
const BookDetails = () => {
  ...
  const { bookId, image, bookName, author, category } = location.state;
  return <div>
      <div className="card bg-base-100 p-5 shadow-sm">
            ...
            <div className="py-3 space-x-4">
              <div className="badge bg-gray-100 text-green-500">{location.state.tags[0]}</div>
              <div className="badge bg-gray-100 text-green-500">{location.state.tags[1]}</div>
            </div>
            <div className="">
